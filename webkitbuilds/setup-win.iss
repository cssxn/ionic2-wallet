...
#define MyAppPublisher "REITsChain"
#define MyAppURL "https://reitschain.com"
...
[Files]
Source: "Wallet\win64\Wallet.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "Wallet\win64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Root: HKCR; Subkey: "wallet"; ValueType: "string"; ValueData: "URL:Wallet Custom Protocol"; Flags: uninsdeletekey
