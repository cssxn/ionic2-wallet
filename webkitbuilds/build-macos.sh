...
# ln -s ../resources/mac/dmg-background.tiff dmg-background.tiff
# rm volume-icon.icns
# ln -s ../resources/mac/volume-icon.icns volume-icon.icns
DMG_VOLUME_ICON="../resources/mac/volume-icon.icns"
DMG_BACKGROUND_IMG="../resources/mac/dmg-background.tiff"
...
then
  ...
  export IDENTITY="3rd Party Mac Developer Application: REITsChain (884JRH5R93)"
...
ln -s /Applications "Applications" # <- not your ordinary space
popd
...
cp -p "${DMG_BACKGROUND_IMG}" /Volumes/"${VOL_NAME}"/.background/
